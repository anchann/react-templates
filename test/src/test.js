...
test('html tests', function (t) {
    var files = ['scope.rt','scope-variable-references.rt',  'scope-evaluated-after-if.rt', 'scope-evaluated-after-repeat.rt', 'scope-trailing-semicolon.rt', 'lambda.rt', 'eval.rt', 'props.rt', 'custom-element.rt', 'style.rt', 'concat.rt', 'js-in-attr.rt', 'props-class.rt', 'rt-class.rt'];
    t.plan(files.length);
